...
$Activo = $consultas->verificaSesion($sesion);
	...
	if(isset($_POST['clave'])){
		$row=$consultas->Modificacion("DatosDepartamento",$clave);
...
?>
    ...
    <div class="row">
   <div class="col-md-4">
            <a id="ModDepartamento"  url="departamento.php" submodulo="<?=$submodulo;?>" modcve="<?=$modcve;?>" modulo="<?=$modulo;?>" onclick="modulos(this);" href="#">Regresar</a>
        </div>
    </div>
		...
		<div id="NuevoDepartamento" class="row">
			 ...
			 <form id="Datos" action="#"  method="post">
			 	<div class="row">
				          ...
				          <div class="col-md-2">
				           <input type="text" id="clave" name="clave" placeholder="ID" value="<?=$row['AreaCve']?>" class="form-control" disabled/>
			 			...
			 			<div class="row">
				          ...
				          <div class="col-md-4">
     					<input type="text" id="nombre" name="nombre" value="<?=$row['AreaDesc']?>" placeholder="Nombre" class="form-control" required/>
				          </div>
				         
				      </div>
				      <div class="row">
				          <div class="col-md-2">
				          <label>Correo de Departamento</label>   
				            </div>
				          <div class="col-md-4">
     					<input type="text" id="correo" name="correo" value="<?=$row['Areacorreo']?>" placeholder="Nombre" class="form-control" required/>
				          </div>
				       ...
				       <div class="row">
					   	...
					   	<div class="col-md-2">
							...
							<div class="col-md-1">    <input type="Checkbox"   name="status" id="status" type='text' class="form" value="" <?php echo ($row['AreaEstatus']=="1" ? "checked" : "" ) ?>/>					  	
							</div>
     ...
     $(function(){
	        ...
	        $("#Datos").validate({
	            ...
	            submitHandler: function(form) {
	            		 ...
	            		 if($("#clave").val()==""){
						    var accion="NuevoDepartamento";

						  }else{
						     var accion="ModificaDepartamento";
