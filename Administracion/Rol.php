...
<div class="row">
        ...
        <div class="col-md-4">
            <a id="ModRol"  url="ModRol.php" submodulo="<?=$submodulo;?>" modcve="<?=$modcve;?>" modulo="<?=$modulo;?>" onclick="modulos(this);" href="#">Nuevo Rol</a>
        </div>               
</div>
...
Listado de Roles de Usuario</div>
...
<form id="frmModulos" name="frmModulos" action="Inicio.php" method="POST">
      ...
      <input type="hidden" name="paginared" id="paginared" value="ModRol">
</form>
...
$(document).ready(function(){
        ...
        CargarFiltro(1,"ListadoRoles",parametros);
