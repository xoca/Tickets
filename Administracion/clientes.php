...
<div class="row">
        ...
        <div class="col-md-4">
            <a id="ModCliente"  url="ModCliente.php" submodulo="<?=$submodulo;?>" modcve="<?=$modcve;?>" modulo="<?=$modulo;?>" onclick="modulos(this);" href="#">Nuevo Cliente</a>
        </div>               
</div>
...
<form id="frmModulos" name="frmModulos" action="Inicio.php" method="POST">
      ...
      <input type="hidden" name="paginared" id="paginared" value="ModCliente">
</form>
...
$(document).ready(function(){
        ...
        CargarFiltro(1,"ListadoClientes",parametros);
