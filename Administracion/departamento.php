...
<div class="row">
        ...
        <div class="col-md-4">
            <a id="ModDepartamento"  url="ModDepartamento.php" submodulo="<?=$submodulo;?>" modcve="<?=$modcve;?>" modulo="<?=$modulo;?>" onclick="modulos(this);" href="#">Nuevo Departamento</a>
        </div>               
</div>
...
<form id="frmModulos" name="frmModulos" action="Inicio.php" method="POST">
      ...
      <input type="hidden" name="paginared" id="paginared" value="ModDepartamento">
</form>
...
$(document).ready(function(){
        ...
        CargarFiltro(1,"ListadoDepartamento",parametros);
